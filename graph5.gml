...
<graphml xmlns="http://graphml.graphdrawing.org/xmlns" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://graphml.graphdrawing.org/xmlns http://graphml.graphdrawing.org/xmlns/1.0/graphml.xsd">
  ...
  <key attr.name="demand/supply7" attr.type="int" for="node" id="d15" />
  <key attr.name="demand/supply6" attr.type="int" for="node" id="d14" />
  <key attr.name="demand/supply5" attr.type="int" for="node" id="d13" />
  <key attr.name="demand/supply7" attr.type="int" for="node" id="d12" />
  <key attr.name="demand/supply6" attr.type="int" for="node" id="d11" />
  <key attr.name="demand/supply5" attr.type="int" for="node" id="d10" />
  <key attr.name="demand/supply7" attr.type="int" for="node" id="d9" />
  <key attr.name="demand/supply6" attr.type="int" for="node" id="d8" />
  <key attr.name="demand/supply5" attr.type="int" for="node" id="d7" />
  <key attr.name="demand/supply4" attr.type="int" for="node" id="d6" />
  <key attr.name="demand/supply3" attr.type="int" for="node" id="d5" />
  <key attr.name="demand/supply2" attr.type="int" for="node" id="d4" />
  <key attr.name="demand/supply1" attr.type="int" for="node" id="d2" />
